...
@XmlSeeAlso({
    GetCompatibilitySearchNamesRequest.class,
    GetProductSearchDataVersionRequest.class,
    GetProductSearchNamesRequest.class,
    GetProductSearchValuesBaseRequest.class
})
